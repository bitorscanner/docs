---
title: Setup Guide
description: Learn how to configure Bitor through the web interface
---

# Setting Up Bitor

This guide will walk you through the initial setup process using the Bitor web interface.

## Initial Login

After starting Bitor, navigate to `http://localhost:8090` in your browser.
...
1. Check the logs using `./bitor logs`
