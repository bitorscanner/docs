...
description: Learn how to set up Bitor for development and contribute to the project
---

# Development Guide

This guide will help you set up Bitor for development and explain how to contribute to the project.
...
```bash
git clone https://github.com/bitorscanner/bitor
cd bitor
```
...
- Check the [documentation](https://bitorscanner.io)
