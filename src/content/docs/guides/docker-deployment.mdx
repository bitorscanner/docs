...
description: Deploy Bitor using Docker and Docker Compose
---
...
This guide will help you deploy Bitor using Docker and Docker Compose.
...
## Quick Start
The fastest way to get Bitor running with Docker:
...
- `/app/pb_data`: Persistent storage for Bitor data
...
```bash
# Backup data
tar czf bitor_backup.tar.gz docker/data docker/nuclei-templates

# Restore data
tar xzf bitor_backup.tar.gz
```
